...
<?php
	$imagem_id = get_field('background_home'); // pega o ID da imagem
	...
	.introducao{
		...
		<section class="introducao">
			<div class="container">
				...
				<a href="/cursos/origamid/wp_bikcraft/produtos/" class="btn">Orçamento</a>
			</div>
		</section>
		...
		<section class="produtos container animar">
			...
			<div class="call">
				...
				<a href="/cursos/origamid/wp_bikcraft/produtos/" class="btn btn-preto">Produtos</a>
			</div>
